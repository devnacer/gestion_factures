...
return [
    ...
    */
    ...
    'Value Added Tax (VAT) Rate' => 'Value Added Tax (VAT) Rate',
    'Select VAT rate' => 'Select VAT rate',
    'Value Added Tax (VAT) Amount' => 'Value Added Tax (VAT) Amount',
    'Total Including Tax' => 'Total Including Tax',
    'Notes' => 'Notes',
    'File input' => 'File input',
    'Choose file' => 'Choose file',
    'Attachment format pdf, jpeg, .jpg, png' => 'Attachment format pdf, jpeg, .jpg, png',
    'Please enter the invoice number.' => 'Please enter the invoice number.',
    'Enter Collection Amount' => 'Enter Collection Amount',
    'Enter Commission Amount' => 'Enter Commission Amount',

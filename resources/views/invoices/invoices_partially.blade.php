...
@section('title')
    {{ trans('titles.Partially Paid Invoices') }}
@endsection
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ trans('invoices.Partially paid invoices') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header d-flex">
                    <h3 class="card-title mr-auto">{{ trans('invoices.Partially paid invoices') }}</h3>
                    @can('Add Invoice')

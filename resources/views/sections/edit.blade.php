                ...
                <form class="form-horizontal" action="{{ route('sections.update', $section->id) }}" method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="description"
                                class="col-sm-2 col-form-label">{{ trans('sections.Description') }}</label>
                            <div class="col-sm-10">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-secondary"
                            name="edit">{{ trans('sections.Validate') }}</button>
                        <button id="btnClose" type="submit"
                            class="btn btn-default float-right">{{ trans('sections.Close') }}</button>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
